...
/*
 * La clase CuentaBancaria con una nueva funcionalidad para la Práctica 16.
 */
...
public class CuentaBancaria {
    ...
    // Nuevo método para obtener los últimos dígitos del número de cuenta (nuevo en Práctica 16)
    public String obtenerUltimosDigitos(int cantidad) { //
        if (cantidad <= 0 || cantidad > numeroCuenta.length()) { //
            return "Cantidad no válida"; //
        } //
        // Utiliza el método substring para obtener los últimos 'cantidad' dígitos
        return numeroCuenta.substring(numeroCuenta.length() - cantidad); //
    }
}